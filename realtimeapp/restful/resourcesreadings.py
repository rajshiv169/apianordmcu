...
resource_fields = {
    ...
    'moisture1' : fields.Float,
    'moisture2' : fields.Float,
}
...
parser.add_argument('humidity',type=float , 
    help="<temperature> has to be a number 'float'")
parser.add_argument('moisture1',type=float , 
    help="<moisture1> has to be a number 'float'")
parser.add_argument('moisture2',type=float , 
    help="<moisture2> has to be a number 'float'")
...
class Reading(Resource):
    ...
    def put(self, reading_id):
        ...
        reading.moisture1 = float('{:.3}'.format(args['moisture1']))
        reading.moisture2 = float('{:.3}'.format(args['moisture2']))
...
class ReadingList(Resource):
    ...
    def post(self, **kwargs):
        ...
        reading = ThermHygReading( 
                        ...
                        moisture1 = float('{0:.2f}'.format(args['moisture1'])),
                        moisture2 = float('{0:.2f}'.format(args['moisture2']))
        )
        reading.save()
