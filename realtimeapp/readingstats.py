...
def readings_to_matrix(raw_readings):
    ...
    for readings_touples in readings_list:
        ...
        moisture1=readings_touples[1]['moisture1']
        moisture2=readings_touples[1]['moisture2']

        readings_matrix.append([readingid, date, temperature, humidity, moisture1, moisture2])
